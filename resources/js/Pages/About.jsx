        ...
        <>
            ...
            <main>
                <section className="px-5 py-10 md:p-10 lg:p-20">
                    ...
                    <p className="open-sans mt-2 text-2xl text-black opacity-70"  data-aos-delay="100">
                        Bondepart Apartemen merupakan agen penyewaan penginapan Apartemen dengan sistem Harian, Bulanan dan Tahunan dengan fasilitas unit dan fasilitas umum yang sangat lengkap, memudahkan mobilisasi perjalanan anda di tengah kota bandung.
                        ...
                        Bondepart Apartemen hadir dengan konsep yang memudahkan konsumen dan wisatawan untuk memulai perjalannnya di tengah kota Bandung dengan pelayanan 24 jam dan keramahtamahan yang dimiliki Bondepart Apartemen.
                    </p>
                </section>
                <section className="w-full px-5 md:px-10 lg:px-20 py-10 md:py-20 lg:py-32 flex flex-wrap justify-between gap-8 bg-gradient-to-br from-[--secondary-color] to-[--primary-color]">
                    <div className="lg:w-[30%] flex gap-x-4" >
                        ...
                        <div className="w-[90%]">
                            ...
                            <p className="open-sans mt-2 text-2xl text-white opacity-70">
                                Menjadi penginapan modern terdepan yang mengutamakan kenyamanan dan keramahtamahan untuk konsumen.
                            </p>
                        </div>
                    </div>
                    <div className="lg:w-[30%] flex gap-x-4" >
                        ...
                        <div className="w-[90%]" >
                            ...
                            <p className="open-sans mt-2 text-2xl text-white opacity-70">
                                Menyediakan penginapan modern dan Estetik dengan fasilitas lengkap, keamanan 24 jam dan akses yang strategis.                            </p>
                        </div>
                    </div>
                    <div className="lg:w-[30%] flex gap-x-4" >
                        <div className="w-10 h-10 flex justify-center items-center bg-white rounded-lg">
                ...
                <section className="w-full min-h-screen h-auto px-5 py-10 md:p-10 lg:p-20 flex flex-col lg:flex-row gap-x-5 bg-[--third-color]">
                    <figure className="lg:w-2/4 h-full relative" >
                        <img src="https://res.cloudinary.com/dqnqorsvp/image/upload/v1739768324/Site_Office_Jarrdin_Cihampelas_2_tocpkq.png" alt="Example" className="w-full md:w-[478px] h-96 md:h-[400px] lg:h-[600px] rounded-lg shadow-lg" />
                    </figure>
                    <div className="lg:w-2/4 mt-5 lg:mt-0">
                        ...
                        <p className="open-sans mt-2 text-2xl text-black opacity-70" >
                            Kami berkomitmen untuk memberikan pengalaman terbaik dengan menciptakan penginapan yang aman dan nyaman.
                        </p>
                        <ul className="w-full mt-2">
                            <li className="w-full mt-6 flex gap-x-3" >
                                <FaTrashAlt className="text-3xl mt-3 opacity-80" />
                                <div className="w-[80%] mt-3">
                                    <p className="open-sans text-2xl text-black opacity-70" >
                ...
                <section className="w-full px-5 py-10 md:p-10 lg:p-20 flex justify-center bg-white">
                    <p className="w-[90%]  text-center open-sans mt-2 text-3xl md:text-4xl text-blalck opacity-70" >
                        Kami berkomitmen untuk memberikan kenyamanan dengan penginapan yang berkualitas
                    </p>
                </section>
                <section className="w-full h-auto px-5 py-10 md:p-10 lg:p-20 flex flex-col items-center gap-y-5 bg-[--third-color]">
                    ...
                    <iframe  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.0012870880732!2d107.5657234!3d-6.8904478!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e514475c499b%3A0x14f7ec6eedd81781!2sGateway%20Pasteur%20by%20Bon.depart!5e0!3m2!1sen!2sid!4v1737451622578!5m2!1sen!2sid" className="w-full h-[450px]" loading="lazy"></iframe>
                    <iframe  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3960.7213581738074!2d107.61559477499652!3d-6.923874443075854!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e62b9c22d201%3A0xc0903468e1f49fc7!2sApartemen%20Grand%20Asia%20Afrika%2C%20Jl.%20Karapitan%20No.1%2C%20Paledang%2C%20Lengkong%2C%20Bandung%20City%2C%20West%20Java%2040261!5e0!3m2!1sen!2sid!4v1737451812170!5m2!1sen!2sid" className="w-full h-[450px]" loading="lazy"></iframe>
                </section>
            </main>
            <Footer />
        </>
