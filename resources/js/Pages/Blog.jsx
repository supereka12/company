...
export default function ArtikelPage() {
    ...
    return (
        <>
            <Navbar />
            <main>
                <section className="bg-[--primary-color] h-[70vh] flex flex-col items-center justify-center text-center text-white py-12">
                    <TextHead title={"Blogs Bondepart"} color={"text-white"} />
                    <p className="w-[420px] open-sans mt-2 text-2xl text-white opacity-70">
                        Here you can find the latest company news and business articles.
                    </p>
                    <div className="w-[40%] mt-5 relative flex items-center">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                        <div className="">
                            <figure className="h-40">
                                <img className="h-full" src="/images/pexels-quark-studio-1159039-3201921.jpg" alt="" />
                            </figure>
                            <Link href="/" className="font-bold poppins-light line-clamp-2 opacity-80 text-black hover:underline">Interior sederhana Populer tahun 2025 di indonesia</Link>
